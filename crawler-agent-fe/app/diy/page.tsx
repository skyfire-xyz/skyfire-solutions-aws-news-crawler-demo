            ...
            <>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  response - Missing KYAPay token in the skyfire-pay-id header.
                  Please create an account at https://app.skyfire.xyz and create
                  a kya token - https://docs.skyfire.xyz/reference/create-token
                  and include it in your request in the skyfire-pay-id header.
                </p>
              ...
              <div className="mb-8">
                ...
                <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-800">
                    ...
                    JSON response containing a token field. Copy the entire JWT
                    token value for use in Step 4.
                  </p>
              ...
              <div className="mb-8">
                ...
                <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-800">
                    ...
                    {selectedAwsName.includes("API Gateway")
                      ? `Lambda Authorizer function`
                      : `Lambda@Edge function`}{" "}
                    to verify your agent&apos;s identity and authorization.
                  </p>
                </div>
