...
export default function DIYPage() {
  const [selectedAws, setSelectedAws] = useState<string>(AWS_URLS[0].url)
  const [dropdownOpen, setDropdownOpen] = useState<boolean>(false)

  const selectedAwsName =
    AWS_URLS.find((a) => a.url === selectedAws)?.name || ""

  let checkBotType = selectedAwsName.includes("WAF")

  const selectedUserAgentWithToken = checkBotType
    ? WithTokenBotTypes[0].userAgent
    : ""

  const selectedUserAgentWithoutToken = checkBotType
    ? WithoutTokenBotTypes[0].userAgent
    : ""

  const step1Curl = checkBotType
    ? `curl "${selectedAws}" \\
    --header "user-agent: ${selectedUserAgentWithoutToken}" `
    : `curl "${selectedAws}"`
  ...
  const step4Curl = checkBotType
    ? `curl "${selectedAws}" \\
  --header "user-agent: ${selectedUserAgentWithToken}" \\
          ...
          <div className="max-w-5xl mx-auto w-full">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                without proper authentication. You&apos;ll receive a 403 error
                response - Missing KYA token `skyfire-pay-id`. Please create an
                account at https://app.skyfire.xyz and create a KYA token -
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                token. This token will be used to authenticate your requests and
                grant access to the protected website. Replace{" "}
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Bot with Skyfire Identity - Allowed Now use the KYA token from
                Step 3 to access the protected website. Replace{" "}
              ...
              <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  ...
                  validated by Fastly Compute to verify your agent&apos;s
