...
export default function TopBar({
  selectedUrl,
  showAwsLink: showAwsLinkProp,
}: TopBarProps) {
  const showAwsGithubLink = !!selectedUrl && AWS_URLS.includes(selectedUrl)
  const showAwsLink =
    typeof showAwsLinkProp === "boolean" ? showAwsLinkProp : showAwsGithubLink
  return (
    <div className="pl-36 pt-6">
      ...
      <div className="container mx-auto px-4 py-0">
        <div className="max-w-4xl">
          ...
          <div className="mb-4">
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-200 px-3 py-1 text-sm font-medium text-blue-800">
          ...
          {/* Main Title */}
          <h1 className="mb-4 text-5xl font-extrabold">Smart Web Crawler</h1>

          {/* Description */}
          <p className="mb-6 text-lg text-gray-600 max-w-2xl">
            This demo web crawler illustrates how token-based identification can
            be used to access and crawl protected websites. There are two sample
            URLs provided:
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Accessible to the crawler without any token.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Requires a KYA token to allow crawler access.
                </p>
              </div>
            </div>
          </div>
